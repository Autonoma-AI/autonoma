...
![The SDK step of Finish setup in Autonoma, showing a "Validate SDK" button with a green confirmation beside it reading "Discovered 12 models". Above the button, a validation target selector names the preview the check ran against and the SDK endpoint URL it called](/img/environment-factory/sdk-validated.png)
