...
Choosing between them is a question about where test data lands, and it is the one the questionnaire asks you to self-assess: _is all your data tenant-scoped?_ An agent sitting in your repo can read the schema and answer it from evidence. So it picks, with `select_preview_path`, and tells you which it chose and why - you can still change it in the UI.
