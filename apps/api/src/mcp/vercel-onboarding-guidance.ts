...
Your tools here: get_vercel_setup, link_vercel_project, create_vercel_deployment, get_vercel_deployment_status, select_vercel_deployment, get_session_status (for the preview URL and your control state - it carries no build logs on this path), plus the SDK and scenario/recipe tools once a deployment is selected.
