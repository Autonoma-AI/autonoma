            ...
            DeployRequest: {
                ...
                properties: {
                    ...
                    cloneUrl: {
                        ...
                        format: "uri",
                        deprecated: true,
                        description: "Ignored. The build clones from repoFullName using the installation token.",
                        example: "https://github.com/acme-corp/my-repo.git",
                    },
                    baseSha: { type: "string" },
                    baseRef: { type: "string", deprecated: true, description: "Ignored.", example: "main" },
                },
                required: ["repoFullName", "prNumber", "headSha", "headRef"],
            },
            DeployAccepted: {
                type: "object",
                properties: {
