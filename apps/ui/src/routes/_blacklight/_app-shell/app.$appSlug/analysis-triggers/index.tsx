...
export const Route = createFileRoute("/_blacklight/_app-shell/app/$appSlug/analysis-triggers/")({
  loader: async ({ context, params: { appSlug } }) => {
    ...
    if (activeOrg?.mergeGateEnabled !== true) {
...
function AnalysisTriggersPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <SettingsTabNav activeTab="analysis-triggers" appSlug={appSlug} />
