...
/**
 * The AI SDK language-model handle the agent loop drives. Narrowed to the v4 specification - the
 ...
 */
export type LanguageModel = Extract<AISDKLanguageModel, { specificationVersion: "v4" }>;
