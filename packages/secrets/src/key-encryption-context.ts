...
/**
 * The additional authenticated data an encryption key is wrapped under. Minting
 ...
 * log the context make each unwrap traceable to the encryption key it was for.
 */
