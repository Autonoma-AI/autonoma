...
import type { InspectableStep, ScreenshotLoader } from "../tools/run-evidence/run-evidence-types";
import type { StepInspectionLoop } from "../tools/run-evidence/step-inspection-loop";
 ...
 * {@link StepInspectionLoop} so the screenshot tools can resolve the
...
export class ReviewerLoop<TResult>
    ...
    implements StepInspectionLoop, CodebaseLoop, ScenarioDataLoop
{
